...
def _calc_ev_pi(x, y, n_bins):
    ...
    for i in range(n_bins):
        ...
        y_subset = y[sorted_idxs[i*n_samples_per_bin:(i+1)*n_samples_per_bin]]
...
def sorting_evppi(x, y, n_bins=None):
...
def sorting_multi_evppi(x, y, n_bins=None, significance_threshold=1e-3):
    ...
    for i in range(n_variables):
        this_evpi = sorting_evppi(x[:, i], y, n_bins)
